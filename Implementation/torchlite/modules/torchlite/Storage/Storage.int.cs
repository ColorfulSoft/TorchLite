...
namespace System.AI.Experimental
{
    ...
    public static partial class torchlite
    {
        ...
        public unsafe partial class Storage
        {
            ...
            /// <summary>
            /// Converts the current storage to the torchlite.int32 data type.
            /// </summary>
            /// <returns>IntStorage.</returns>
            public Storage @int()
            {
                var s = new Storage(this.size, torchlite.int32);
                var dst = (int*)s.data_ptr;
                var n = this.size;
                switch(this.dtype)
                {
