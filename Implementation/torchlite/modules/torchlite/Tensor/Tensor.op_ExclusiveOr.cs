...
namespace System.AI.Experimental
{
    ...
    public static partial class torchlite
    {
        ...
        public unsafe partial class Tensor
        {
            ...
            /// <summary>
            /// Performs elementwise power of left and right tensors if at least one argument is FloatTensor, else computes elementwise xor with broadcasting.
            /// </summary>
                        ...
                        switch(right.dtype)
                        {
                            case torchlite.float32:
                            {
                                ...
                                for(int i = 0; i < result_numel; ++i)
                                {
                                    ...
                                    result_ptr[i] = (float)Math.Pow(left_ptr[li], right_ptr[ri]);
                                }
                                    ...
                                    result.backward_fn = () =>
                                    {
                                        ...
                                        if(!right.requires_grad)
                                        {
                                            ...
                                            for(int i = 0; i < result_numel; ++i)
                                            {
                                                ...
                                                left_grad_ptr[li] += result_grad_ptr[i] * (float)Math.Pow(left_ptr[li], right_ptr[ri] - 1) * right_ptr[ri];
                                            }
                                        ...
                                        if(!left.requires_grad)
                                        {
                                            ...
                                            for(int i = 0; i < result_numel; ++i)
                                            {
                                                ...
                                                right_grad_ptr[ri] += result_grad_ptr[i] * (float)(Math.Pow(left_ptr[li], right_ptr[ri]) * Math.Log(left_ptr[li]));
                                            }
                                            Marshal.FreeHGlobal((IntPtr)left_strides);
                                            Marshal.FreeHGlobal((IntPtr)right_strides);
                                            Marshal.FreeHGlobal((IntPtr)result_strides);
