...
namespace System.AI.Experimental
{
    ...
    public static partial class torchlite
    {
        ...
        public unsafe partial class Tensor
        {
            ...
            /// <summary>
            /// Performs elementwise division of left and right tensors with broadcasting.
            /// </summary>
                                    ...
                                    result.backward_fn = () =>
                                    {
                                        ...
                                        if(!right.requires_grad)
                                        {
                                            ...
                                            for(int i = 0; i < result_numel; ++i)
                                            {
                                                ...
                                                left_grad_ptr[li] += result_grad_ptr[i] / right_ptr[ri];
                                            }
                                        ...
                                        if(!left.requires_grad)
                                        {
                                            ...
                                            for(int i = 0; i < result_numel; ++i)
                                            {
                                                ...
                                                right_grad_ptr[ri] -= result_grad_ptr[i] * left_ptr[li] / (right_ptr[ri] * right_ptr[ri]);
                                            }
                                            Marshal.FreeHGlobal((IntPtr)left_strides);
                                            Marshal.FreeHGlobal((IntPtr)right_strides);
                                            Marshal.FreeHGlobal((IntPtr)result_strides);
